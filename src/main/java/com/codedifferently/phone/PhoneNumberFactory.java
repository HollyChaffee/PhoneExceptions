...
public final class PhoneNumberFactory {
    ...
    public static PhoneNumber createPhoneNumberSafely(int areaCode, int centralOfficeCode, int phoneLineCode) {
        ...
        try {
            ...
            //validate all arguments - in correct format
            //turn into string
            //pass into method
            return createPhoneNumber(phoneNumber);
        } catch (InvalidPhoneNumberFormatException e) { //try to use the method, else return null
    ...
    public static PhoneNumber createPhoneNumber(String phoneNumberString) throws InvalidPhoneNumberFormatException {
        logger.warning("Attempting to create a new phone number object with a value of " + phoneNumberString);
